...
export default function ShopPage() {
  ...
  // Fetch products from Woo Store API
  useEffect(() => {
  ...
  return (
    <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-screen">
      <div className="flex flex-col md:flex-row justify-between items-end mb-16">
        <div>
          <h1 className="text-4xl md:text-6xl font-serif mb-6 text-midnight">
            Shop Collection
          </h1>
          <p className="text-gray-500 max-w-md">
            Discover our latest arrivals, crafted with precision and passion
              ...
              {products.map((product) => (
                ...
                >
                  ...
                  <div className="text-center">
                    <h3 className="font-serif text-xl mb-2 text-midnight group-hover:text-gold transition-colors duration-300">
                      {product.name}
                    </h3>
